...
## Instruction
Since the shiny app cannot be knitted in the project.rmd file due to directory changes, we separate this Shiny App.rmd file to show the shiny app we made. To use the shiny app, simply run all the chunks and it will automatically show up. 
